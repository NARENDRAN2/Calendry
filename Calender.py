...
def myAccount():
	...
	Label(account,text = "Meeting Requests",font=("Helvetica",12,"bold"),fg = "#3b5998").place(x=70,y=200)
	...
	if(prow == None):
		Label(account,text = f"No meeting requests so far!",fg="red").place(x=70, y= 250)
		pflag = 1
	...
	Label(account,text = "Schedule a meeting",font=("Helvetica",12,"bold"),fg = "#3b5998").place(x=70,y=310)
	...
	Button(account, text='Schedule',width=6,bg='brown',fg='white',command = schedule).place(x=120,y=430)
...
header = Label(root, text="New to Calendry?",width=20,font=("bold", 20),fg="brown")
header.place(x=100,y=53)
...
already = Label(root, text="Already a Member!Click login",width=20,font=("bold", 10))
already.place(x=180,y=470)
